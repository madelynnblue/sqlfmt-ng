 ...
 */
export function check_roundtrip(original, rendered, dialect) {
    const ptr0 = passStringToWasm0(original, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(rendered, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(dialect, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.check_roundtrip(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[1]) {
 ...
 * @returns {string}
 */
export function fmt(sql, dialect, width, tab_width, use_tabs, _case) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.fmt(ptr0, len0, ptr1, len1, width, tab_width, use_tabs, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
export function fmt_postgres_json(parse_tree_json, width, tab_width, use_tabs, _case) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.fmt_postgres_json(ptr0, len0, width, tab_width, use_tabs, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function parse_to_ir(sql, dialect) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(sql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(dialect, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.parse_to_ir(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {boolean}
 */
export function pg_json_ast_equal(json1, json2) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.pg_json_ast_equal(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sqlfmt_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
